"""Tests for slm4ie/data/sloleks.py and slm4ie/data/tokenization.py."""
...
from slm4ie.data import sloleks, tokenization
...
class TestToTokenizerEvalConverter:
    """Integration tests for slm4ie/data/tokenization.py."""
    ...
    def test_missing_xml_raises(self, tmp_path: Path):
        ...
        with pytest.raises(FileNotFoundError):
            list(tokenization._read_sloleks(empty_dir))
    ...
    def test_read_sloleks_auto_unzips(self, tmp_path: Path):
        ...
        records = list(tokenization._read_sloleks(raw_dir))
    ...
    def test_read_sloleks_relations_auto_unzips(self, tmp_path: Path):
        ...
        records = list(tokenization._read_sloleks_relations(raw_dir))
