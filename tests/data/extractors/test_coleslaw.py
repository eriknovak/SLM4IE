...
class TestColeslawExtractor:
    ...
    def test_pisrs_uses_text_field(self, extractor: ColeslawExtractor, tmp_path: Path) -> None:
    ...
    def test_usrs_uses_full_text(self, extractor: ColeslawExtractor, tmp_path: Path) -> None:
    ...
    def test_sodna_courts_concatenates_sections(self, extractor: ColeslawExtractor, tmp_path: Path) -> None:
        ...
        docs = list(extractor.extract(tmp_path, "coleslaw", "legal"))
        assert docs[0].text == "Bistvo zadeve.\n\nRazveljavi se.\n\nObrazložitev sledi."

    def test_sodna_claims_concatenates_structured_fields(self, extractor: ColeslawExtractor, tmp_path: Path) -> None:
    ...
    def test_invalid_lines_logged_and_skipped(self, extractor: ColeslawExtractor, tmp_path: Path) -> None:
