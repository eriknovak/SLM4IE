"""Tests for the NER backend (slm4ie/data/tasks/converters/spans.py)."""
...
class TestConvertEndToEnd:
    """End-to-end conversion driven through `convert_tasks`."""
    ...
    def test_writes_split_files(self, tmp_path: Path) -> None:
        ...
        convert_tasks(config_path, entry_keys=["ner/kzb"], max_workers=1)
