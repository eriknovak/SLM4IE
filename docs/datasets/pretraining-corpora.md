...
Once downloaded and extracted, the corpora are converted to the
[datatrove format](../user-guide/data-pipeline/datatrove.md) and curated
into the final pretraining corpus via
[`curate.py`](../user-guide/data-pipeline/curate.md).
