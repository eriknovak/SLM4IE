...
| Sloleks             | [`to_tokenization.py`](../user-guide/data-pipeline/tokenizer-eval.md)          |

The task converters and evaluation are implemented but not yet run
end-to-end — see the 🚧 banners on those pages. Once converted, run
[Evaluation](../user-guide/evaluation.md) to score trained models.
